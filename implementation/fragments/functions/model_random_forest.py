...
def train_random_forest(target_column_name, original_name_dataset, smote):
    ...
    def plot_result(x_label, y_label, plot_title, train_data, val_data):
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig(f'./fragments/joblibs/{original_name_dataset}/model/random_forest/k_cross_plot.png')
        plt.show()
    ...
    # Storing the model
    if smote:
        dump(random_forest, f"./fragments/joblibs/{original_name_dataset}/model/random_forest/random_forest_model_smote.joblib")
    else:    
        dump(random_forest, f"./fragments/joblibs/{original_name_dataset}/model/random_forest/random_forest_model.joblib")

    # Returning the results of the training model
    return confussion_matrix, random_forest_results